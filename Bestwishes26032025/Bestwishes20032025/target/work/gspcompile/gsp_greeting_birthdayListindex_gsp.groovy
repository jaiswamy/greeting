...
class gsp_greeting_birthdayListindex_gsp extends GroovyPage {
...
invokeTag('captureBody','sitemesh',326,['class':("page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid")],1)
printHtmlPart(38)
}
...
public static final long LAST_MODIFIED = 1742968939368L
