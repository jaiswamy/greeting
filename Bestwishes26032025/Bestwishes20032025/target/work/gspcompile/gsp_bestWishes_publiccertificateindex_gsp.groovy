...
class gsp_bestWishes_publiccertificateindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/publiccertificate/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(35)
expressionOut.print(createLink(controller:'vcadmincreation', action:'downloadCertificate'))
printHtmlPart(36)
...
public static final long LAST_MODIFIED = 1742457706212L
